...
namespace DematecStock.Domain.Repositories.ProductAddress
{
    ...
    {
        Task<LocationQueryResult> GetStoredItemsByLocation(int idLocation, string? isActive, string? isMovementAllowed, string? isAllowReplenishment, string? isPickingLocation, string? isProductInactive);
